...
if (!skip) {
	...
	tab_hash_saida = le_compartimentos(NOME_ARQUIVO_HASH);
        ...
        //imprime_compartimentos(tab_hash_saida)
...
if (!skip) {
	...
	salva_clientes(NOME_ARQUIVO_DADOS, tab_cliente);
        ...
        //end = insere(70, "Marcos", NOME_ARQUIVO_HASH, NOME_ARQUIVO_DADOS, 2);
	//end = insere(50, "Maria", NOME_ARQUIVO_HASH, NOME_ARQUIVO_DADOS, 3);
        
	ASSERT_EQUAL(end, 1);
        ListaClientes *aux = le_clientes(NOME_ARQUIVO_DADOS);
        //imprime_clientes(tab_cliente);
        //printf("\n__________________\n");
        imprime_clientes(aux);
        libera_clientes(aux);
